...
function Dashboard() {
  ...
  useEffect(() => {
    async function getdados() {
      try {
        const responseEventos = await sheets.getAllEventos();
  ...
  // Processar os dados para o gráfico pizza de aniversario dos usuarios
  ...
  return(
    <div style={{padding:20}}>
        <h2> Dashboards </h2>
        <div style={{ width:"600px", marginBottom: 40 }}><Bar data={barData}/></div>
